                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <?php
                        $qry= "SELECT * FROM tblstudents where courseId = '$_SESSION[courseId]' and lectureRoomId = '$_SESSION[lectureRoomId]' ORDER BY firstName ASC";
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        where tblattendance.admissionNo = '$admissionNumber' and tblstudents.courseId = '$_SESSION[courseId]' and tblstudents.lectureRoomId = '$_SESSION[lectureRoomId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        tblstudents.firstName,tblstudents.lastName,tblstudents.email,tblstudents.admissionNumber
                        FROM tblattendance
                        INNER JOIN tblclass ON tblcourse.Id = tblattendance.courseId
                        INNER JOIN tbllecturerooms ON tbllecturerooms.Id = tblattendance.lectureRoomId
                        INNER JOIN tblsemester ON tblsemester.Id = tblattendance.semesterId
                        INNER JOIN tblsem ON tblsem.Id = tblsemester.semId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.courseId = '$_SESSION[courseId]' and tblattendance.lectureRoomId = '$_SESSION[lectureRoomId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN tblsem ON tblsem.Id = tblsemester.semId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.courseId = '$_SESSION[courseId]' and tblattendance.lectureRoomId = '$_SESSION[lectureRoomId]'";
