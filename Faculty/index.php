   ...
   <?php include "Includes/sidebar.php";?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <!-- Topbar -->
        <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper" style="min-height:80vh">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Teacher Dashboard (<?php echo $rrw['courseName'].' - '.$rrw['lectureRoomName'];?>)</h1>
            <ol class="breadcrumb">
          ...
          <?php 
$query1=mysqli_query($conn,"SELECT * from tblstudents where courseId = '$_SESSION[courseId]' and lectureRoomId = '$_SESSION[lectureRoomId]'");                       
...
?>
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT * from tblattendance where courseId = '$_SESSION[courseId]' and lectureRoomId = '$_SESSION[lectureRoomId]'");                       
