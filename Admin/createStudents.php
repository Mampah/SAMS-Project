...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,email,admissionNumber,password,courseId,lectureRoomId,dateCreated) 
    value('$firstName','$lastName','$email','$admissionNumber','$sampPass_2','$courseId','$lectureRoomId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    email='$email', admissionNumber='$admissionNumber',password='12345', courseId='$courseId',lectureRoomId='$lectureRoomId'
    where Id='$Id'");
            if ($query) {
            ...
            <div class="col-lg-12">
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="email" class="form-control" name="email" value="<?php echo $row['email'];?>" id="exampleInputEmail" >
                        </div>
                        <div class="col-xl-6">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblcourse.courseName,tbllecturerooms.lectureRoomName,tbllecturerooms.Id AS lectureRoomId,tblstudents.firstName,
