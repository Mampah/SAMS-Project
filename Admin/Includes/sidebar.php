 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createCourse.php">Create Class</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapusers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Lecture Rooms</h6>
            <a class="collapse-item" href="createLectureRooms.php">Create Lecture Room</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Course Lecturer</h6>
             <a class="collapse-item" href="createFaculty.php">Create Course Lecturer</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"> Academic Year & Semester</h6>
            <a class="collapse-item" href="createSemester.php">Create Year & Semester</a>
        ...
        <div id="collapseBootstrapcon1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAttendance.php">Course Attendance Report</a>
